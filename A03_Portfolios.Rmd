...
My 10 stocks: Coca-Cola (KO), McDonald´s (MCD), YUM!Brands (YUM), PepsiCo (PEP), General Mills (GIS), Kellogg Company (K), The Hershey Company (HSY), Hormel Foods (HRL), Campbell Soup (CPB) and Walmart (WMT)

Create a vector with the stocks I want to observe
```{r}
stockselection <- c("KO", "MCD", "YUM", "PEP", "GIS", "K", "HSY", "HRL", "CPB", "WMT")
stockselection
```
